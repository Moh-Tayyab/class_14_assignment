...
const page = async ({params}: {params: tParams}) => {
    const url = await fetch(`https://jsonplaceholder.typicode.com/comments/${(await params).id}`)
  ...
  return (
    <div className="p-6 bg-[#ffcdcd] min-h-screen flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-lg">
        <h2 className="text-2xl font-bold mb-4 text-gray-800">Comment Details:</h2>
